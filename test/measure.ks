...
describe('color.measure', func() {
	it('contrast(#abc, #963)', func() { // {{{
		let c = new Color('#abc').contrast(Color.from('#963'))
	...
	it('contrast(#abc, rgba(153, 102, 51, 0.5))', func() { // {{{
		let c = new Color('#abc').contrast(Color.from('rgba(153, 102, 51, 0.5)'))
	...
	it('contrast(rgba(72, 23, 159, 0.9), rgba(153, 102, 51, 0.5))', func() { // {{{
		let c = new Color('rgba(72, 23, 159, 0.9)').contrast(Color.from('rgba(153, 102, 51, 0.5)'))
	...
	it('distance', func() { // {{{
		let d = new Color('#abc').distance(Color.from('#963'))
